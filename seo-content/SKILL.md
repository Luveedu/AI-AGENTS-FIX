---
name: seo-content
description: 'Elite SEO architecture, technical auditing, and EEAT-focused content strategy. Use when analyzing URLs/keywords for #1 rankings, creating SEO-optimized content, auditing technical SEO, writing anti-AI human-grade content, or implementing schema markup.'
argument-hint: 'URL or keyword to analyze, or SEO task'
---
...
- **Formatting:** Use bullet points, bold text for scannability, and data tables. Do not write massive walls of text. do not use em dashed. ( — )
